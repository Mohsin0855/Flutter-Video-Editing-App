...
class MultiVideoTrimTimeline extends StatelessWidget {
  const MultiVideoTrimTimeline({
    Key? key,
  ...
  final List<VideoEditorController> controllers;
  final int quantity;
...
class TrimTimeline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (_, constraint) {
      final int count = (max(1, (constraint.maxWidth / MediaQuery.of(context).size.width)) *
        ...
        child: IntrinsicWidth(
          child: Row(
            ...
            children: List.generate(count, (i) {
              ...
              final text = (t.inMilliseconds / 1000).toStringAsFixed(1).padLeft(2, '0');
